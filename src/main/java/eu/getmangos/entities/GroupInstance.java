...
@NamedQueries({
    ...
    @NamedQuery(name = "GroupInstance.findById", query = "SELECT g FROM GroupInstance c WHERE g.groupInstancePK.leaderguid = :guid AND g.groupInstancePK.instance = :instance"),
